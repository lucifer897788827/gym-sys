...
describe("WhatsappSettingsPage", () => {
  it("renders prefilled WhatsApp templates", () => {
    ...
    expect(screen.getByRole("heading", { name: /whatsapp follow-up templates/i })).toBeTruthy();
    expect(screen.getByText(/Hi Ravi, your membership ends on 2026-04-03/i)).toBeTruthy();
    expect(screen.getByText(/Hi Asha, thanks for visiting Strong Box/i)).toBeTruthy();
  });
});
